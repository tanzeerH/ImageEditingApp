...
public abstract class MultiTouchEntity extends View implements Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 4424849361757579102L;

	public MultiTouchEntity(Context context) {
		super(context);
